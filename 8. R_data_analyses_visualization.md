...
(p1 <- ggplot(Hg_data_surface, aes(y = MeHg, x = day, color = site)) +
  ...
  geom_smooth(span = 0.2, se = FALSE, alpha = 1, linewidth = 3))
...
SUVA_data_surface <- OM_data_surface[!is.na(OM_data_surface$DOM_SUVA254), ]  
SUVA_data_rhizosphere <- OM_data_rhizosphere[!is.na(OM_data_rhizosphere$DOM_SUVA254), ]  

# remove rows where SUVA254 equals NA
DOM_data_surface <- OM_data_surface[!is.na(OM_data_surface$DOM), ]  
DOM_data_rhizosphere <- OM_data_rhizosphere[!is.na(OM_data_rhizosphere$DOM), ]  
...
# remove rows where SUVA254 equals NA
OM_data_surface <- OM_data_surface[!is.na(OM_data_surface$DOM), ]  
OM_data_rhizosphere <- OM_data_rhizosphere[!is.na(OM_data_rhizosphere$DOM), ]  
...
ggboxplot(geochemical_anova.m, x = "Site", y = "value",
  ...
  theme(legend.position = "right",
        axis.line = element_line(linewidth = 0.1),  # Ensure axis lines are the same thickness
        text = element_text(color = "black"),
        axis.text.x = element_blank(),
        axis.ticks.x = element_blank(),
        panel.border = element_rect(fill = NA, linewidth = 1),  # Standard line size
        strip.background = element_rect(linetype = "solid", color = "black", linewidth = 1))
